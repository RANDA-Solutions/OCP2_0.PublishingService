...
namespace OpenCredentialPublisher.Credentials.Tests
{
    public class VerifiableCredentialsTests
    {
        ...
        //    {
        //        Context = new[] { "https://www.w3.org/2018/credentials/v1", "https://contexts.ward.guru/clr_v1p0.jsonld" },
        //        Type = new List<string>(new[] { nameof(VerifiableCredential) }).ToArray(),
        ...
        //        CredentialSubject = new List<ICredentialSubject>(new[] { clrSet }),
